//wizard directive
angular.module('nxt-angular-timeline').directive('ionTimeline', function() {
    return {
        restrict: 'EA',
        replace: true,
        transclude: true,
        ...
        templateUrl: function(element, attributes) {
            return attributes.template || "ion-timeline.html";
        },

        //controller for wizard directive, treat this just like an angular controller
        controller: ['$scope', '$element', '$log', '$q', '$timeout', function ($scope, $element, $log, $q, $timeout) {
